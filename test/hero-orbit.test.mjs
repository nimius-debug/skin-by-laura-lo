...
assert.match(document, /styles\.css\?v=20260908-ingredient-review/, "the shared CSS bypasses stale caches");
assert.match(document, /cart\.js\?v=20260908-ingredient-review/, "the client script bypasses stale caches");
