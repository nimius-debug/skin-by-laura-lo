...
assert.match(document, /styles\.css\?v=20260910-routine-cta/, "the shared CSS bypasses stale caches");
assert.match(document, /cart\.js\?v=20260910-routine-cta/, "the client script bypasses stale caches");
