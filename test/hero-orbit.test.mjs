...
assert.match(CLIENT_JS, /110 \+ depth \* 2/, "cards cross Laura's depth plane continuously");
...
assert.match(document, /styles\.css\?v=20260902-hero-orbit-2/, "the orbit CSS bypasses stale caches");
assert.match(document, /cart\.js\?v=20260902-hero-orbit-2/, "the orbit script bypasses stale caches");
